 ...
 <div className={`dashboard-container ${collapsed ? 'collapsed' : ''}`}>
  ...
  <div className="sidebar-header p-2 border-b-2 " style={{borderBottom:'2px solid #bf9debff'}}>
        ...
        <ul className="nav-links p-2">
          ...
          <li> <i className="fa-solid fa-book-open"></i> <Link to="myresult" className='text-white text-decoration-none'>My Results</Link></li>
          <li> <i className="fa-solid fa-user"></i><Link to="changepassword" className='text-white text-decoration-none'> Change Password</Link></li>
           ...
           <li><i className="fa-solid fa-message"></i> <Link to="message" className='text-white text-decoration-none'>Message</Link></li>
          <li><i className="fa-solid fa-arrow-right-from-bracket"></i> <Link className='text-decoration-none text-white' 
